function subplotwedge(theta,Nx,Np,Field,Tcrt)
%,xx,fw1,fol1
%[col] = marc_colors();
fontsz=15;
...
% text(x_b1(1,end),y_b1(1,end),'100')


% text(-0.05,-0.01,'0','interpreter','latex')
% text(-0.2,0.181,'100','interpreter','latex')
% text(-0.29,0.372,'200','interpreter','latex')
% text(-0.38,0.563,'300','interpreter','latex')
% text(-0.47,0.758,'400','interpreter','latex')
% text(-0.515,0.9,'470','interpreter','latex')

xtext0=0.032+[-0.1 -0.22 -0.3 -0.38 -0.46 -0.515];
